...
/**
 * Write a description of class CarsCarsCarsTester here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class CarsCarsCarsTester
{
    public static void main(String []args)
    {
        ...
        CarsCarsCars car1 = new CarsCarsCars(type, startMiles, endMiles, gals * price, (endMiles - startMiles) / gals, gals / price);
        CarsCarsCars car2 = new CarsCarsCars(type2, startMiles2, endMiles2, gals2 * price, (endMiles2 - startMiles2) / gals2, gals2 / price);
        CarsCarsCars car3 = new CarsCarsCars(type3, startMiles3, endMiles3, gals3 * price, (endMiles3 - startMiles3) / gals3, gals3 / price);
