...
/**
 * Write a description of class CarsCarsCars here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class CarsCarsCars
{
    ...
    public CarsCarsCars(String type, int endMi, int startMi, double galUsed, double pricePerGal, double costOfGals) {
        carType = type;
        endMiles = endMi;
        startMiles = startMi;
        gallonsUsed = galUsed;
